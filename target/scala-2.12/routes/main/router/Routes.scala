...
// @SOURCE:/home/wdd/webapps/play/lab2/conf/routes
...
class Routes(
  ...
  // @LINE:12
  private[this] lazy val controllers_HomeController_updateProductSubmit6_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("updateProductSubmit/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_HomeController_updateProductSubmit6_invoker = createInvoker(
  ...
  // @LINE:14
  private[this] lazy val controllers_HomeController_deleteCustomer8_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("delCustomer/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_HomeController_deleteCustomer8_invoker = createInvoker(
  ...
  // @LINE:16
  private[this] lazy val controllers_HomeController_updateCustomer10_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("updateCustomer/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_HomeController_updateCustomer10_invoker = createInvoker(
  ...
  // @LINE:18
  private[this] lazy val controllers_HomeController_productDetails11_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("productDetails/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_HomeController_productDetails11_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:12
    case controllers_HomeController_updateProductSubmit6_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_HomeController_updateProductSubmit6_invoker.call(HomeController_0.updateProductSubmit(id))
      }
  
    // @LINE:13
    case controllers_HomeController_deleteProduct7_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_HomeController_deleteProduct7_invoker.call(HomeController_0.deleteProduct(id))
      }
  
    // @LINE:14
    case controllers_HomeController_deleteCustomer8_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_HomeController_deleteCustomer8_invoker.call(HomeController_0.deleteCustomer(id))
      }
  
    // @LINE:15
    case controllers_HomeController_updateProduct9_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_HomeController_updateProduct9_invoker.call(HomeController_0.updateProduct(id))
      }
  
    // @LINE:16
    case controllers_HomeController_updateCustomer10_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_HomeController_updateCustomer10_invoker.call(HomeController_0.updateCustomer(id))
      }
  
    // @LINE:18
    case controllers_HomeController_productDetails11_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_HomeController_productDetails11_invoker.call(HomeController_0.productDetails(id))
      }
